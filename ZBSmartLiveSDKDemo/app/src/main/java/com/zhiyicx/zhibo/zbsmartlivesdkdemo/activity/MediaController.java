 ...
 */
public class MediaController extends FrameLayout implements ZBMediaController {
    ...
    private static int sDefaultTimeout = Integer.MAX_VALUE;
    ...
    private void initControllerView(View v) {
        ...
        mShareButton = (ImageButton) v.findViewById(R.id.share);
